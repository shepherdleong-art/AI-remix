    ...
    if (!isElectron && fileObjectsRef.current.size > 0) {
      ...
      try {
        for (const item of validatedFiles) {
          ...
          const resp = await fetch(`${baseUrl}/api/materials/upload`, {
            method: 'POST',
            body: formData,
          });
      ...
      <DialogContent dividers>
        ...
        <Box
          ...
          sx={{
            ...
            mb: 2,
            textAlign: 'center',
            bgcolor: dragOver ? 'action.selected' : 'background.paperAlt',
        ...
        {validatedFiles.length > 0 && (
          <Box>
            ...
            <List dense sx={{ maxHeight: 240, overflow: 'auto', bgcolor: 'background.paperAlt', borderRadius: 1 }}>
